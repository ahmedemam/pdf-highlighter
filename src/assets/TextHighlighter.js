(function (global) {
    ...
    function defaults(obj, source) {
        console.log('defaults', obj, source);
        obj = obj || {};
    ...
    function refineRangeBoundaries(range) {
        console.log('refineRangeBoundaries', range);
    ...
    function groupHighlights(highlights) {
        console.log('groupHighlights', highlights);
    ...
    var dom = function (el) {
        ...
        return /** @lends dom **/ {
            ...
            prepend: function (nodesToPrepend) {
                console.log('prepend', nodesToPrepend);
            ...
            insertBefore: function (refEl) {
                console.log('insertBefore', refEl);
            ...
            normalizeTextNodes: function () {
                console.log('normalizeTextNodes');
                if (!el) {
                    return;
                }
    ...
    function TextHighlighter(element, options) {
        console.log('TextHighlighter', element, options);
        if (!element) {
    ...
    TextHighlighter.prototype.highlightHandler = function () {
        console.log('highlightHandler', dom(this.el).getRange());
        ...
        const createElement = () => {
            ...
            z.onclick = this.doHighlight.bind(this);
        ...
        console.log("on before highligth inside do hightlight")
        z.onclick = this.doHighlight.bind(this);
    ...
    TextHighlighter.prototype.doHighlight = function (keepRange) {
        console.log('doHighlight', keepRange, this.el);
        var range = dom(this.el).getRange(),
            wrapper,
            createdHighlights,
            normalizedHighlights,
    ...
    TextHighlighter.prototype.highlightRange = function (range, wrapper) {
        console.log('highlightRange', range, wrapper);
        if (!range || range.collapsed) {
            return [];
        }
    ...
    TextHighlighter.prototype.normalizeHighlights = function (highlights) {
        console.log('normalizeHighlights', highlights);
    ...
    TextHighlighter.prototype.flattenNestedHighlights = function (highlights) {
        console.log('flattenNestedHighlights', highlights);
        var again,
            self = this;
    ...
    TextHighlighter.prototype.mergeSiblingHighlights = function (highlights) {
        console.log('mergeSiblingHighlights', highlights);
        var self = this;
    ...
    TextHighlighter.prototype.serializeHighlights = function () {
        console.log('serializeHighlights');
    ...
    TextHighlighter.prototype.deserializeHighlights = function (json) {
        console.log('deserializeHighlights', json);
        var hlDescriptors,
            highlights = [],
            self = this;
    ...
    TextHighlighter.prototype.find = function (text, caseSensitive) {
        console.log('find', text, caseSensitive);
